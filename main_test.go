...
var examples = []example{
	...
	{"f104",
		"foo '''bar''' '''baz''' qux",
		"foo <strong>bar</strong> <strong>baz</strong> qux",
		""},
	{"f105",
		"foo '''''bar''''' baz",
	...
	{"l102",
		...
		""},
	{"l103",
		"foo [[Bar|some label|foo]] baz",
		`foo <a href="Bar">some label|foo</a> baz`,
		""},
	...
	// Images
	{"i101",
		"foo [[File:filename.extension]] baz",
		`foo <img src="filename.extension" options="" link=""></img> baz`, ""},
	{"i102",
		"foo [[File:filename.extension|options]] baz",
		`foo <img src="filename.extension" options="options" link=""></img> baz`,
		""},
	{"i103",
		"foo [[File:filename.extension|options|caption words]] baz",
		`foo <img src="filename.extension" options="options" link="">caption words</img> baz`,
		""},
	{"i104",
		"foo [[File:filename.extension|options|link=Internal]] baz",
		`foo <img src="filename.extension" options="options" link="Internal"></img> baz`,
		""},
	{"i105",
		"foo [[File:filename.extension|options|link=http://External]] baz",
		`foo <img src="filename.extension" options="options" link="http://External"></img> baz`,
		""},
	...
	// <nowiki>
	{"w101",
		"foo <nowiki>''qux''</nowiki> baz",
		`foo <nowiki data="JydxdXgnJw=="></nowiki> baz`,
		""},
	{"w102",
		"foo <nowiki abc>''qux''</nowiki> baz",
		`foo <nowiki data="JydxdXgnJw==" abc></nowiki> baz`,
		""},

	// Templates
	{"t101",
		"foo {{bar}} baz",
		`foo <template name="bar"></template> baz`,
		"foo {{bar}}\nbaz"},
	{"t102",
		"foo {{bar|qux}} baz",
	...
	{"t201",
		"foo {{bar\n|{{qux\n|xyz}}\n|a=c}}\nbaz",
		"foo <template name=\"bar\"><arg name=\"\"><template name=\"qux\"><arg name=\"\">xyz</arg></template>\n</arg><arg name=\"a\">c</arg></template>\nbaz",
		"foo {{bar\n|{{qux\n|xyz}}\n\n|a=c}}\n\nbaz"},
